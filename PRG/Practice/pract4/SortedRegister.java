...
public class SortedRegister {
    ...
    public int add(Scanner sc) {
        ...
        try {
            ...
            System.out.println("ERROR. Línea " + count + ": Dato no entero.");
            count = -1;
        } catch (IllegalArgumentException e) {
            System.out.println("ERROR. Línea " + count + ": " + e.getMessage());
            count = -1;
        }
        return count;
    } 
    ...
    public int add(Scanner sc, PrintWriter err) {
        ...
        while (sc.hasNext()) {    
            ...
            try {
                ...
                err.println("ERROR. Línea " + count + ": Dato no entero.");
            } catch (IllegalArgumentException e) {
                err.println("ERROR. Línea " + count + ": " + e.getMessage());
            }
        }
        return count;
    }
